...
public class VectorAutoInput : InputController
{
    ...
    {
        Collider2D[] zombiesWithinRange = Physics2D.OverlapCircleAll(Tower.gameObject.transform.position, Tower.Range).Where(col => col.gameObject.CompareTag(Tags.Zombie)).ToArray();
